insert into Assignment1_AsishP.Reviews_AsishP(Review,Comments,ReviewID,BuyerID,ProductID) values
("4","its good product","200","100","400"),
("4","product is very good","201","101","401"),
("5","product is very useful","202","102","402"),
("3","product is very good","203","103","403"),
("5","files are very clear","204","104","404"),
("3","products are useful","205","105","405"),
("5","book is very nice","206","106","406"),
("3","concepts are easy","207","107","407"),
("4","easy concepts","208","108","408"),
("5","its good product","209","109","409"),
("3","its good product","210","110","410"),
("4","great one","211","111","411"),
("4","concepts are easy","212","112","412"),
("2","its not useful","213","113","413"),
("1","its very bad","214","114","414"),
("4","its good product","215","115","415"),
("5","good product","216","116","416"),
("3","products are good","217","117","417"),
("1","its a bad product","218","118","418"),
("1","good product","219","119","419");
select * from Assignment1_AsishP.Reviews_AsishP;


insert into Assignment1_AsishP.Customer_AsishP (CustomerID,FirstName,LastName,Email,Username,I_Teach_Grade,Password,Zipcode,PhoneNo,City,Country,Address,BuyerID,SellerID)VALUES 
...
SELECT * FROM Assignment1_AsishP.Customer_AsishP;


insert into Assignment1_AsishP.Product_AsishP(ProductTitle,ResourceType,GradeLevel,SubjectArea,ProductID,TeachingDuration,No_of_Slides,Type,Price,BundleDiscountPrice,MultipleLicensePrice,MakeProductActive,CopyRightInfo) VALUES
...
SELECT * FROM Assignment1_AsishP.Product_AsishP;



insert into Assignment1_AsishP.Transactions_AsishP(TransactionID,ProductID,Amountpaid,Date,SellerID,BuyerID) VALUES
...
SELECT * FROM Assignment1_AsishP.Transactions_AsishP;